...
- Avoid em-dashes (`—`) and en-dashes (`–`) — they're a dead giveaway of AI writing
- Humans rarely use them in plain text; restructure instead (two sentences, comma, parentheses)
- Exception: code comments where the author's style already uses them (check existing code first)
